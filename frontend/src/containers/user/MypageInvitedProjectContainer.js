...
const MypageInvitedProjectContainer = ({ isLogin, userInfo, addUserInfo, myEntList, setIsLogin, addToMyEntList }) => {
	return (
...
export default connect(mapStateToProps, mapDispatchToProps)(MypageInvitedProjectContainer);
