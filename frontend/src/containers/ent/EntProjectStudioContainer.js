...
import EntProjectStudio from "../../components/ent/EntProjectStudio";

const EntProjectStudioContainer = ({ userInfo, addUserInfo, myEntList, setIsLogin, addToMyEntList }) => {
	return (
		<EntProjectStudio
			userInfo={userInfo}
