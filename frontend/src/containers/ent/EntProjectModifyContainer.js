...
import EntProjectModify from "../../components/ent/EntProjectModify";

const EntProjectModifyContainer = ({
	userInfo,
	addUserInfo,
	myEntList,
	setIsLogin,
...
export default connect(mapStateToProps, mapDispatchToProps)(EntProjectModifyContainer);
