...
import EntProjectMemberInvite from "../../components/ent/EntProjectMemberInvite";

const EntProjectMemberInviteContainer = ({
	userInfo,
	addUserInfo,
	myEntList,
	setIsLogin,
...
export default connect(mapStateToProps, mapDispatchToProps)(EntProjectMemberInviteContainer);
