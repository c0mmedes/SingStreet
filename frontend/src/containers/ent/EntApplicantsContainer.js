...
const EntApplicantsContainer = ({ userInfo, addUserInfo, myEntList, setIsLogin, addToMyEntList }) => {
	return (
		<EntApplicants
			userInfo={userInfo}
...
export default connect(mapStateToProps, mapDispatchToProps)(EntApplicantsContainer);
