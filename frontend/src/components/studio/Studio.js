...
const Studio = () => {
  ...
  useEffect(()=>{
    const init = async ()=> {
        // const provider = new WebsocketProvider('ws://localhost:8080/chatt', 1 , ydoc);
        const provider = new WebsocketProvider('ws://localhost:8080/chatt', 1 , ydoc);
        // const provider = new WebsocketProvider('wss://i9b110.p.ssafy/backend/chatt', 1 , ydoc);
  ...
  // 2.================================================Yjs관련 초기 설정=================================================================
  useEffect(()=>{
    console.log("useEffectStart",blockList);
