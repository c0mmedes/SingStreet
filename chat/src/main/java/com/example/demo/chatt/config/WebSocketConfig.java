package com.example.demo.chatt.config;

import com.example.demo.chatt.service.WebSocketHandlerImpl;
...
public class WebSocketConfig implements WebSocketConfigurer {//implements WebSocketMessageBrokerConfigurer
    ...
    public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
        registry.addHandler(new WebSocketHandlerImpl(), "/ws/chatt/{entId}")
                .setAllowedOrigins("*");
    }
